...
> Discord reaction roles bot, click emoji to get role 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

🎭 &nbsp;**Emoji roles** — react to an emoji to get a role

📌 &nbsp;**Sticky panels** — persistent role selection messages

🔘 &nbsp;**Button support** — modern button-style panels

📋 &nbsp;**Select menus** — dropdown role selection

⛔ &nbsp;**Limits** — cap how many roles from one panel

🔄 &nbsp;**Toggle** — react again to remove the role
